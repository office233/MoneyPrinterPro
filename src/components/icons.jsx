// Minimal lucide-style stroke icons, sized to inherit currentColor.
// Width/height default to 16px; pass `size` to override.
...
export const IconExternal = ({ size }) => (
  <svg {...base(size)}>
...
export const IconSparkles = ({ size }) => (
  <svg {...base(size)}>
    ...
    <path d="M19 17v3M17.5 18.5h3M5 4v2M4 5h2" />
  </svg>
);
